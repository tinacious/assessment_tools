...
describe('Perfect Paddles', () => {
  ...
  describe('HTML', () => {
    ...
    it('social media links use FontAwesome', () => {
      ...
      Assert.equal($('[class*="fa-facebook"]').length, 1, 'Facebook icon not found');
      Assert.equal($('[class*="fa-instagram"]').length, 1, 'Instagram icon not found');
      Assert.equal($('[class*="fa-twitter"]').length, 1, 'Twitter icon not found');
      Assert.equal($('[class*="fa-pinterest"]').length, 1, 'Pinterest icon not found');
      Assert.equal($('[class*="fa-google-plus"]').length, 1, 'Google+ icon not found');
    });
